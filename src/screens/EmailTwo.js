                                    ...
                                    <View style={{ width: '100%', alignSelf: 'center' }}>
                                        <Card>
                                            ...
                                            <View style={{
                                                ...
                                                <View >
                                                    <Text style={{ marginBottom: 10, fontWeight: 'bold' }}>Job Title : </Text>
                                                </View>
                                                <View>
                        ...
                        <View style={styles.modalView}>
                            ...
                            <View style={styles.btn}>
                                ...
                                <TouchableHighlight style={{ ...styles.openButton, backgroundColor: "#c60017", flex: 1, textAlign: 'center' }}>
                                    <Text style={styles.textStyle} onPress={() => { props.navigation.navigate('ApplyJob'), setModalVisible(!modalVisible) }}>Confirm</Text>
                                </TouchableHighlight>
                            </View>
                        </View>
                    </View>
