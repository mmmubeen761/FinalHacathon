...
function Admin(props) {
    ...
    function Deletefunc(e) {
        database()
            .ref('/').child(`StudentAccount/${ali[e]}`).remove()
            .then((res) => { 
                database()
                .ref('/').child('StudentAccount')
                .on('value', snapshot => {
        ...
        <>
            <View style={styles.action}>
                <FontAwesome onPress={() => props.navigation.openDrawer()}
                    ...
                    size={30}
                />
                <Text style={styles.textInput}>STUDENTS DATA</Text>
            </View>
            <ScrollView>
                        ...
                        <View style={styles.modalView}>
                            ...
                            <View style={styles.btn}>
                                ...
                                <TouchableHighlight style={{ ...styles.openButton, backgroundColor: "#c60017", flex: 1, textAlign: 'center' }}>
                                    <Text style={styles.textStyle} onPress={() => { Deletefunc(), setModalVisible(!modalVisible) }}>Confirm</Text>
                                </TouchableHighlight>
                            </View>
                        </View>
                    </View>
