...
function CompanyData(props) {
    ...
    const ali = Object.keys(data);


    function Deletefunc(e) {
        database()
            .ref('/').child(`CompanyAccount/${ali[e]}`).remove()
            .then((res) => {
                database()
                .ref('/').child('CompanyAccount')
                .on('value', snapshot => {
        ...
        <>
            <View style={styles.action}>
                <FontAwesome onPress={() => props.navigation.openDrawer()}
                    ...
                    size={30}
                />
                <Text style={styles.textInput}>COMPANY DATA</Text>
            </View>
            <ScrollView>
                                    ...
                                    <View style={{ width: '100%', alignSelf: 'center' }}>
                                        <Card>
                                            ...
                                            <View style={{
                                                ...
                                                <View >
                                                    <Text style={{ marginBottom: 10, fontWeight: 'bold' }}>Company Title : </Text>
                                                </View>
                                                <View>
                                            ...
                                            <View style={{
                                                ...
                                                <View >
                                                    <Text style={{ marginBottom: 10, fontWeight: 'bold' }}>Self : </Text>
                                                </View>
                                                <View>
                                                    <Text style={{ marginBottom: 10 }}>Yes</Text>
                                                </View>
                                            </View>
                                            <Button onPress={() => {
                                                Deletefunc(id)
