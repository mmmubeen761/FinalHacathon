                ...
                <ImageBackground source={{uri:'https://image.shutterstock.com/image-vector/back-school-set-different-signs-260nw-1453000499.jpg'}} style={styles.image}>
                        <View style={styles.midcont}>
                            <FontAwesome  onPress={() => props.navigation.openDrawer()}
                                ...
                                size={30}
                            />
                            <Text style={{ color: 'white', fontSize: 25, fontWeight: 'bold', padding: 20, alignItems: 'center' }}>COMPANIES
                                 </Text>
                            <Text>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  </Text>
                                    ...
                                    <View style={{ width: '100%', alignSelf: 'center' }}>
                                        <Card>
                                            ...
                                            <View style={{
                                                ...
                                                <View >
                                                    <Text style={{ marginBottom: 10, fontWeight: 'bold' }}>Company Name : </Text>
                                                </View>
                                                <View>
                                                    <Text style={{ marginBottom: 10 }}>{data[val].companyName}</Text>
                                                </View>
                                            </View>
                                            <View style={{
                                                width: '80%',
