        ...
        <>
            <View style={styles.action}>
                <FontAwesome onPress={() => props.navigation.openDrawer()}
                    ...
                    size={30}
                />
                <Text style={styles.textInput}>JOB OFFERS</Text>
            </View>
            <ScrollView>
                                        ...
                                        <Card>
                                            <View style={{ flex: 1, flexDirection: 'row' }}>
                                                ...
                                                <Card.Title style={{ fontSize: 20, color: 'black', alignSelf: 'flex-start', paddingLeft: 10, paddingTop: 20 }}>
                                                    {data[val].companyName}</Card.Title>
                                            </View>
                                            ...
                                            <View style={{
                                                ...
                                                <View >
                                                    <Text style={{ marginBottom: 10, fontWeight: 'bold' }}>Phone Number : </Text>
                                                </View>
                                                <View>
                                                    <Text style={{ marginBottom: 10 }}>{data[val].companyTitle}</Text>
                                                </View>
                                            </View>
                                            <View style={{
                                                width: '80%',
                                                ...
                                                <View >
                                                    <Text style={{ marginBottom: 10, fontWeight: 'bold' }}>Work Experince : </Text>
                                                </View>
                                                <View>
                                                    <Text style={{ marginBottom: 10 }}>{data[val].work}</Text>
                                                </View>
                                            </View>
                                            <View style={{
                                                width: '80%',
                                                ...
                                                <View >
                                                    <Text style={{ marginBottom: 10, fontWeight: 'bold' }}>Education Level : </Text>
                                                </View>
                                                <View>
                                                    <Text style={{ marginBottom: 10 }}>{data[val].educationlevel}</Text>
                                                </View>
                                            </View>
                                            <Button onPress={() => {
                                                setModalVisible(true);
                                            }}
                                                buttonStyle={{ borderRadius: 0, marginLeft: 0, marginRight: 0, marginTop: 10, backgroundColor: '#0273a3' }}
                                                title='Contact' />
                                        </Card>
                                    </View>
                                </>
                ...
                >
                    <View style={styles.centeredView}>
                        <View style={styles.modalView}>
                                <Text style={{ fontSize: 16, fontFamily: 'Roboto', padding: 15, paddingTop: 20, fontWeight: 'bold', alignSelf: 'center' }}>
                                    You Can Contact this request by his number.
                               </Text>
                            <View style={styles.btn}>
                                ...
                                <TouchableHighlight style={{ ...styles.openButton, backgroundColor: "#c60017", flex: 1, textAlign: 'center' }}>
                                    <Text style={styles.textStyle} onPress={() => { setModalVisible(!modalVisible) }}>Confirm</Text>
                                </TouchableHighlight>
                            </View>
                        </View>
                    </View>
...
const styles = StyleSheet.create({
    ...
    myText: {
        fontSize: 10 // End result looks like the provided UI mockup
    },
    action: {
        width: ('100%'),   // 80% of width device screen
        flexDirection: 'row',
